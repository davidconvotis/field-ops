...
const config = {
  ...
  "inlineSchemaHash": "8a43412b5ea696cf391a34b932dd666572987aff8b713f54616855459aff7f52",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/generated/prisma-test-client",
    "generated/prisma-test-client",
  ]
...
path.join(process.cwd(), "src/generated/prisma-test-client/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/generated/prisma-test-client/schema.prisma")
